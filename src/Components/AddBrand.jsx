            ...
            <div className="hero  bg-base-200 dark:bg-gray-900">
                <div className="hero-content flex-col">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <form onSubmit={handleAddBrand} className="card-body dark:bg-gray-800 rounded-xl">

                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text dark:text-white">Brand Name</span>
                                </label>
                                <input type="text" name="name" placeholder="" className="input input-bordered dark:bg-gray-800 dark:text-white dark:border-white" required />
                            </div>
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" name="image" placeholder="" className="input input-bordered dark:bg-gray-800 dark:text-white dark:border-white" required />
                            </div>
